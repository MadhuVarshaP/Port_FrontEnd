...
use ::data_structures::{Proposal, ProposalInfo, State, Votes, Event};
...
impl DaoVoting for Contract {
    ...
    fn create_event(
        ...
        require(0 < date, CreationError::DurationCannotBeZero);
        ...
        storage
            .events
            .insert(storage.event_count.read(), event);
        storage
            .event_count
            .write(storage.event_count.read() + 1);
